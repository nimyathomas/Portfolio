...
function Portfolio() {
  const portfolios = [
    ...
    },
    {
      ...
      title: "My Portfolio",
      description:
        "A personal portfolio website built to showcase my skills, projects, and experience. It includes sections like About, Skills, Projects, and Contact. The website is fully responsive and developed using modern web technologies.",
...

    {
      ...
      description:
        "A Java-based clinic management system designed to manage patient records, appointments, and doctor details. The project includes modules for registration, login, appointment scheduling, and data storage. It highlights core Java concepts such as OOP, Swing/GUI programming, and database connectivity.",
...

    {
      ...
      description:
        "A full-stack web application designed to help startups register, authenticate, and manage key business information. The system includes secure user login, startup profile creation, category-based filtering, and global startup listing. The backend provides REST APIs for CRUD operations, while the frontend offers a clean and responsive UI for seamless interaction.",
      technologies:
        "Java, Spring Boot, MySQL, REST API, React.js, Axios, JWT Authentication",
      repoLink: "https://github.com/nimyathomas/startup_management",
    },
  ];
  ...
  return (
    <section id="portfolio">
      ...
      <span className="portfolioDesc">
        Here are some of my projects showcasing my skills and learning journey
        as a fresher
      </span>
